...
public class AbandonnedPortalUnderworldNetherStructure extends NegativeNModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("abandonned_portal_underworld_nether"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("negative_n:abandonned_portal_underworld_nether"),
					configuredFeature);
		}
	}
	@SubscribeEvent

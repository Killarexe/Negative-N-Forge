...
public class AbandonnedPortalNetherStructure extends NegativenModElements.ModElement {
	public AbandonnedPortalNetherStructure(NegativenModElements instance) {
		super(instance, 537);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 750) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("negativen", "abandonned_portal_nether"));
						if (template == null)
							return false;

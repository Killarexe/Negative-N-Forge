...
public class AbandonnedPortalNetherNNetherStructure extends NegativenModElements.ModElement {
	public AbandonnedPortalNetherNNetherStructure(NegativenModElements instance) {
		super(instance, 622);
	}

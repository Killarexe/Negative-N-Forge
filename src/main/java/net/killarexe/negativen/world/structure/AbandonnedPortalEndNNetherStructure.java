...
public class AbandonnedPortalEndNNetherStructure extends NegativenModElements.ModElement {
	public AbandonnedPortalEndNNetherStructure(NegativenModElements instance) {
		super(instance, 536);
	}

...
public class AbandonnedPortalEndNStructure extends NegativenModElements.ModElement {
	public AbandonnedPortalEndNStructure(NegativenModElements instance) {
		super(instance, 642);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 750) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("negativen", "abandonned_portal_end"));
						if (template == null)
							return false;

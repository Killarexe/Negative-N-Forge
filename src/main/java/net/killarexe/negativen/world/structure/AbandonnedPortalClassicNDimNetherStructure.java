...
public class AbandonnedPortalClassicNDimNetherStructure extends NegativenModElements.ModElement {
	public AbandonnedPortalClassicNDimNetherStructure(NegativenModElements instance) {
		super(instance, 630);
	}

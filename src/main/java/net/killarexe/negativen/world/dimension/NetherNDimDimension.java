...
import net.killarexe.negativen.item.NetherNDimItem;
...
public class NetherNDimDimension extends NegativenModElements.ModElement {
	@ObjectHolder("negativen:netherndim")
	public static final ModDimension dimension = null;
	@ObjectHolder("negativen:netherndim_portal")
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("netherndim"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("negativen:netherndim")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("negativen:netherndim"), dimension, null, false);
		}
		type = DimensionType.byName(new ResourceLocation("negativen:netherndim"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("negativen:nethern")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("negativen:soul_sand_desert_n")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("negativen:nether_n_warped_biome")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("negativen:nether_n_crimson_biome")),};
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new CustomPortalBlock());
		elements.items.add(() -> new NetherNDimItem().setRegistryName("netherndim"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("netherndim_portal");
		}
		...
		private TeleporterDimensionMod getTeleporterForDimension(Entity entity, BlockPos pos, ServerWorld nextWorld) {
			BlockPattern.PatternHelper bph = NetherNDimDimension.CustomPortalBlock.createPatternHelper(entity.world, pos);
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("netherndim_portal", Vec3i::compareTo, 300);
	@SubscribeEvent
	public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
		try {
			...
			poi = (PointOfInterestType) method.invoke(null, "netherndim_portal",
	...
	public static class TeleporterDimensionMod implements ITeleporter {
		...
		public BlockPattern.PortalInfo placeInExistingPortal(BlockPos p_222272_1_, Vec3d p_222272_2_, Direction directionIn, double p_222272_4_,
			...
			return optional.map((p_226707_7_) -> {
				...
				BlockPattern.PatternHelper blockpattern$patternhelper = NetherNDimDimension.CustomPortalBlock.createPatternHelper(this.world,
						blockpos);
		...
		public ChunkProviderModded(World world, BiomeProvider provider) {
			super(world, provider, new NetherGenSettings() {
				public BlockState getDefaultBlock() {
					return NetherrackNBlock.block.getDefaultState();
				}

				public BlockState getDefaultFluid() {
					return LavaNBlock.block.getDefaultState();
				}
			});

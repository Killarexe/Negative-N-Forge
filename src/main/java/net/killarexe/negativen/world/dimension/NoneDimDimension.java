...
import net.killarexe.negativen.item.NoneDimItem;
...
public class NoneDimDimension extends NegativenModElements.ModElement {
	@ObjectHolder("negativen:nonedim")
	public static final ModDimension dimension = null;
	@ObjectHolder("negativen:nonedim_portal")
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("nonedim"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("negativen:nonedim")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("negativen:nonedim"), dimension, null, false);
		}
		type = DimensionType.byName(new ResourceLocation("negativen:nonedim"));
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new NoneDimItem().setRegistryName("nonedim"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("nonedim_portal");
		}
		...
		private TeleporterDimensionMod getTeleporterForDimension(Entity entity, BlockPos pos, ServerWorld nextWorld) {
			BlockPattern.PatternHelper bph = NoneDimDimension.CustomPortalBlock.createPatternHelper(entity.world, pos);
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("nonedim_portal", Vec3i::compareTo, 300);
	@SubscribeEvent
	public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
		try {
			...
			poi = (PointOfInterestType) method.invoke(null, "nonedim_portal",
	...
	public static class TeleporterDimensionMod implements ITeleporter {
		...
		public BlockPattern.PortalInfo placeInExistingPortal(BlockPos p_222272_1_, Vec3d p_222272_2_, Direction directionIn, double p_222272_4_,
			...
			return optional.map((p_226707_7_) -> {
				...
				BlockPattern.PatternHelper blockpattern$patternhelper = NoneDimDimension.CustomPortalBlock.createPatternHelper(this.world, blockpos);

...
public class ClassicNDimDimension extends NegativenModElements.ModElement {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				ObfuscationReflectionHelper.setPrivateValue(WorldCarver.class, WorldCarver.CAVE, new ImmutableSet.Builder<Block>()
						...
						.add(ClassicStoneNBlock.block.getDefaultState().getBlock()).build(), "field_222718_j");
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("classic_n_dim_portal", Vector3i::compareTo, 300);
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("classic_n_dim_portal", Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())),
					0, 1).setRegistryName("classic_n_dim_portal");

...
import net.killarexe.negativen.entity.IronNGolemNEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class IronNGolemNRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(IronNGolemNEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modeliron_n_golem_n(), 1f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("negative_n:textures/iron_n_golem_n.png");
					}
				};
			});
		}
	...
	public static class Modeliron_n_golem_n extends EntityModel<Entity> {

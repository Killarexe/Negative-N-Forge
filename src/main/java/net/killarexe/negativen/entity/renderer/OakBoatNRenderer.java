...
@OnlyIn(Dist.CLIENT)
public class OakBoatNRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(OakBoatNEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modeloak_n_boat(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("negative_n:textures/oak_n_boat.png");
					}
				};
			});
		}

...
import net.killarexe.negativen.entity.renderer.BirchNBoatRenderer;
...
public class BirchNBoatEntity extends NegativeNModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			...
			.size(0.6f, 0.2f)).build("birch_n_boat").setRegistryName("birch_n_boat");
	public BirchNBoatEntity(NegativeNModElements instance) {
		super(instance, 48);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BirchNBoatRenderer.ModelRegisterHandler());

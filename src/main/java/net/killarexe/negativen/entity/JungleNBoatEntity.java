...
import net.killarexe.negativen.entity.renderer.JungleNBoatRenderer;
...
public class JungleNBoatEntity extends NegativeNModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			...
			.size(0.6f, 0.2f)).build("jungle_n_boat").setRegistryName("jungle_n_boat");
	public JungleNBoatEntity(NegativeNModElements instance) {
		super(instance, 49);
		FMLJavaModLoadingContext.get().getModEventBus().register(new JungleNBoatRenderer.ModelRegisterHandler());

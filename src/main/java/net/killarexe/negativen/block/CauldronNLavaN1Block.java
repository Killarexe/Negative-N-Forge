...
public class CauldronNLavaN1Block extends NegativeNModElements.ModElement {
	@ObjectHolder("negative_n:cauldron_n_lava_n_1")
	public static final Block block = null;
	public CauldronNLavaN1Block(NegativeNModElements instance) {
		super(instance, 897);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cauldron_n_lava_n_1");
		}

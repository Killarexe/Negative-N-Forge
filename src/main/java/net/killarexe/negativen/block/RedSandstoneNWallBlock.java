...
public class RedSandstoneNWallBlock extends NegativenModElements.ModElement {
	@ObjectHolder("negativen:red_sandstone_n_wall")
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("red_sandstone_n_wall");
		}

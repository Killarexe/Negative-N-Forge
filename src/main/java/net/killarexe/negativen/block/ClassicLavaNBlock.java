...
public class ClassicLavaNBlock extends NegativeNModElements.ModElement {
	...
	public void initElements() {
		...
		}.setRegistryName("classic_lava_n"));
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("classic_lava_n_lakes"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("negative_n:classic_lava_n_lakes"), configuredFeature);
		}
	}
	@SubscribeEvent

...
public class RoseBushNBottomBlock extends NegativenModElements.ModElement {
	@ObjectHolder("negativen:rose_bush_n_bottom")
	public static final Block block = null;
	public RoseBushNBottomBlock(NegativenModElements instance) {
		super(instance, 117);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).hardnessAndResistance(1f, 10f).lightValue(0).doesNotBlockMovement()
					.notSolid());
			setRegistryName("rose_bush_n_bottom");
		}

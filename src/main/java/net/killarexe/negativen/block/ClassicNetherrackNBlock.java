...
public class ClassicNetherrackNBlock extends NegativeNModElements.ModElement {

	@ObjectHolder("negative_n:classic_netherrack_n")
	public static final Block block = null;

	public ClassicNetherrackNBlock(NegativeNModElements instance) {
		super(instance, 355);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("classic_netherrack_n");
		}

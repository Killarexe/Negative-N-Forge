...
public class MossyCobblestoneNWallBlock extends NegativeNModElements.ModElement {
	@ObjectHolder("negative_n:mossy_cobblestone_n_wall")
	public static final Block block = null;
	public MossyCobblestoneNWallBlock(NegativeNModElements instance) {
		super(instance, 961);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("mossy_cobblestone_n_wall");
		}

...
public class ClassicGoldNOreBlock extends NegativeNModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("classic_gold_n_ore");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("negative_n:classic_gold_n_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("classic_gold_n_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("negative_n:classic_gold_n_ore"), configuredFeature);
		}
	}
	@SubscribeEvent

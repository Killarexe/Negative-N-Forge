...
public class CrimsonNFenceGateBlock extends NegativeNModElements.ModElement {
	@ObjectHolder("negative_n:crimson_n_fence_gate")
	public static final Block block = null;
	public CrimsonNFenceGateBlock(NegativeNModElements instance) {
		super(instance, 1071);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("crimson_n_fence_gate");
		}

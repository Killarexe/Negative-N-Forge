...
public class ClassicWaterBlock extends NegativenModElements.ModElement {
	@ObjectHolder("negativen:classic_water")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("negativen:classic_water_bucket")
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes.builder(new ResourceLocation("negativen:blocks/water_c"), new ResourceLocation("negativen:blocks/water_c"))

...
public class WarpedNRootBlock extends NegativeNModElements.ModElement {
	@ObjectHolder("negative_n:warped_n_root")
	public static final Block block = null;
	public WarpedNRootBlock(NegativeNModElements instance) {
		super(instance, 1077);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("warped_n_root"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("negative_n:warped_n_root"), configuredFeature);
		}
	}
	@SubscribeEvent

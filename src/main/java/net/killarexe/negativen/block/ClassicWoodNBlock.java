...
public class ClassicWoodNBlock extends NegativeNModElements.ModElement {
	@ObjectHolder("negative_n:classic_wood_n")
	public static final Block block = null;
	public ClassicWoodNBlock(NegativeNModElements instance) {
		super(instance, 399);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(1.9999999999999998f, 12f).setLightLevel(s -> 0)
					.harvestLevel(0).harvestTool(ToolType.AXE).setRequiresTool());
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("classic_wood_n");
		}

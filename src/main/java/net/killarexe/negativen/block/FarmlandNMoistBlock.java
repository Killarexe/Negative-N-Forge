...
import net.killarexe.negativen.procedures.FarmlandNMoistUpdateTickProcedure;
...
public class FarmlandNMoistBlock extends NegativenModElements.ModElement {
	@ObjectHolder("negativen:farmland_n_moist")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ORGANIC).sound(SoundType.GROUND).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0)
					.harvestLevel(0).harvestTool(ToolType.SHOVEL).notSolid().tickRandomly().setOpaque((bs, br, bp) -> false));

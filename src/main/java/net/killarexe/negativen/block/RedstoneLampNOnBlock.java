...
public class RedstoneLampNOnBlock extends NegativeNModElements.ModElement {

	@ObjectHolder("negative_n:redstone_lamp_n_on")
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(
					...
					Block.Properties.create(Material.GLASS).sound(SoundType.GLASS).hardnessAndResistance(1f, 10f).setLightLevel(s -> 15)

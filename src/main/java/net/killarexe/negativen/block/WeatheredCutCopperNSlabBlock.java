...
public class WeatheredCutCopperNSlabBlock extends NegativeNModElements.ModElement {

	@ObjectHolder("negative_n:weathered_cut_copper_n_slab")
	public static final Block block = null;

	public WeatheredCutCopperNSlabBlock(NegativeNModElements instance) {
		super(instance, 891);
	...
	public static class CustomBlock extends SlabBlock {
		...
		public CustomBlock() {
			...
			setRegistryName("weathered_cut_copper_n_slab");
		}

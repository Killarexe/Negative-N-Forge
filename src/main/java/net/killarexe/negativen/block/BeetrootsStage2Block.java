...
public class BeetrootsStage2Block extends NegativenModElements.ModElement {
	@ObjectHolder("negativen:beetroots_stage_2")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("beetroots_stage_2");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.create(0D, 0D, 0D, 1D, 0.6D, 1D).withOffset(offset.x, offset.y, offset.z);
		}

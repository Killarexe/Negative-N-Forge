...
public class NetherNBricksWallBlock extends NegativenModElements.ModElement {
	@ObjectHolder("negativen:nether_n_bricks_wall")
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("nether_n_bricks_wall");
		}

...
public class WarpedNFenceGateBlock extends NegativeNModElements.ModElement {
	@ObjectHolder("negative_n:warped_n_fence_gate")
	public static final Block block = null;
	public WarpedNFenceGateBlock(NegativeNModElements instance) {
		super(instance, 1060);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("warped_n_fence_gate");
		}

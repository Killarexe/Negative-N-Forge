...
public class DeepslateNIronNOreBlock extends NegativeNModElements.ModElement {
	@ObjectHolder("negative_n:deepslate_n_iron_n_ore")
	public static final Block block = null;
	public DeepslateNIronNOreBlock(NegativeNModElements instance) {
		super(instance, 267);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("deepslate_n_iron_n_ore");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(RawIronNItem.block, (int) (1)));
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("negative_n:deepslate_n_iron_n_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("deepslate_n_iron_n_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("negative_n:deepslate_n_iron_n_ore"), configuredFeature);
		}
	}
	@SubscribeEvent

...
public class DeepslateNGoldNOreBlock extends NegativeNModElements.ModElement {
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		}.withConfiguration(new OreFeatureConfig(new BlockMatchRuleTest(DeepslateNBlock.block.getDefaultState().getBlock()) {
		...
		}, block.getDefaultState(), 5)).range(12).square().func_242731_b(1));
	}
}

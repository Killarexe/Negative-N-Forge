...
public class PeonyNTopBlock extends NegativenModElements.ModElement {
	@ObjectHolder("negativen:peony_n_top")
	public static final Block block = null;
	public PeonyNTopBlock(NegativenModElements instance) {
		super(instance, 732);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void animateTick(BlockState state, World world, BlockPos pos, Random random) {
			...
			int y = pos.getY();
			int z = pos.getZ();
			if (PeonyNBottomParticleSpawningConditionProcedure.executeProcedure(ImmutableMap.of("world", world)))
				for (int l = 0; l < 4; ++l) {

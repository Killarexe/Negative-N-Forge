...
public class CrimsonNRootsBlock extends NegativeNModElements.ModElement {
	@ObjectHolder("negative_n:crimson_n_roots")
	public static final Block block = null;
	public CrimsonNRootsBlock(NegativeNModElements instance) {
		super(instance, 178);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("crimson_n_roots"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("negative_n:crimson_n_roots"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("crimson_n_roots");
		}

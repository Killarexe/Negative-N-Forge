...
public class SmallAmethystNBudBlock extends NegativenModElements.ModElement {
	@ObjectHolder("negativen:small_amethyst_n_bud")
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.GLASS).hardnessAndResistance(0.05f, 10f).lightValue(0).harvestLevel(3)

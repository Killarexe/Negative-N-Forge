...
public class CampfireNBlock extends NegativenModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(1.5f, 10f).lightValue(8).harvestLevel(0)
					.harvestTool(ToolType.AXE).notSolid().tickRandomly());

...
public class BrownMushroomNBlock extends NegativeNModElements.ModElement {
	@ObjectHolder("negative_n:brown_mushroom_n")
	public static final Block block = null;
	public BrownMushroomNBlock(NegativeNModElements instance) {
		super(instance, 120);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("brown_mushroom_n"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("negative_n:brown_mushroom_n"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("brown_mushroom_n");
		}

...
public class WheatNStage0Block extends NegativeNModElements.ModElement {
	@ObjectHolder("negative_n:wheat_n_stage_0")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wheat_n_stage_0");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(0, 0, 0, 16, 3.2, 16)).withOffset(offset.x, offset.y, offset.z);
		}

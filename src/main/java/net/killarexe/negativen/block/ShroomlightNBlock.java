...
public class ShroomlightNBlock extends NegativenModElements.ModElement {
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		}.withConfiguration(new OreFeatureConfig(new BlockMatchRuleTest(WapredNyliumNBlock.block.getDefaultState().getBlock()) {
		...
		}, block.getDefaultState(), 20)).range(128).square().func_242731_b(1));
	}
}

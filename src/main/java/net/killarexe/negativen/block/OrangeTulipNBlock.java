...
public class OrangeTulipNBlock extends NegativeNModElements.ModElement {
	@ObjectHolder("negative_n:orange_tulip_n")
	public static final Block block = null;
	public OrangeTulipNBlock(NegativeNModElements instance) {
		super(instance, 105);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("orange_tulip_n"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("negative_n:orange_tulip_n"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("orange_tulip_n");
		}

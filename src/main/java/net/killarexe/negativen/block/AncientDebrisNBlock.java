...
public class AncientDebrisNBlock extends NegativeNModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(
					...
					Block.Properties.create(Material.ROCK).sound(SoundType.ANCIENT_DEBRIS).hardnessAndResistance(3f, 50f).setLightLevel(s -> 0)
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("negative_n:ancient_debris_n_match"),
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 2)).range(17)
					.square().func_242731_b(2);

			event.getRegistry().register(feature.setRegistryName("ancient_debris_n"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("negative_n:ancient_debris_n"), configuredFeature);
		}

...
public class StartStoneBrickWallBlock extends NegativenModElements.ModElement {
	@ObjectHolder("negativen:start_stone_brick_wall")
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("start_stone_brick_wall");
		}

...
public class SmoothStoneNSlabBlock extends NegativenModElements.ModElement {
	@ObjectHolder("negativen:smooth_stone_n_slab")
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.GROUND).hardnessAndResistance(1.3f, 10f).lightValue(0).harvestLevel(1)

...
public class NightLightDetectorBlock extends NegativeNModElements.ModElement {
	@ObjectHolder("negative_n:night_light_detector")
	public static final Block block = null;
	public NightLightDetectorBlock(NegativeNModElements instance) {
		super(instance, 1037);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("night_light_detector");
		}

...
public class PotatoStage2Block extends NegativeNModElements.ModElement {

	@ObjectHolder("negative_n:potato_stage_2")
	public static final Block block = null;

	public PotatoStage2Block(NegativeNModElements instance) {
		super(instance, 716);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("potato_stage_2");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(0, 0, 0, 16, 11.2, 16)
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(PotatoNItem.block, (int) (1)));
		}

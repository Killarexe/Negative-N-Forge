...
import net.killarexe.negativen.procedures.SpruceSaplingNUpdateTickProcedure;
...
public class SpruceSaplingNBlock extends NegativeNModElements.ModElement {
	@ObjectHolder("negative_n:spruce_sapling_n")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("spruce_sapling_n");
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				SpruceSaplingNUpdateTickProcedure.executeProcedure($_dependencies);
			}
		}
	}
}

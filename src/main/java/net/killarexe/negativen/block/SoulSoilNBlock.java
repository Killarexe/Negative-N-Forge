...
public class SoulSoilNBlock extends NegativeNModElements.ModElement {
	@ObjectHolder("negative_n:soul_soil_n")
	public static final Block block = null;
	public SoulSoilNBlock(NegativeNModElements instance) {
		super(instance, 220);
	}

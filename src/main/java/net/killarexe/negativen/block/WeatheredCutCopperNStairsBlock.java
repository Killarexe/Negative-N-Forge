...
public class WeatheredCutCopperNStairsBlock extends NegativeNModElements.ModElement {
	@ObjectHolder("negative_n:weathered_cut_copper_n_stairs")
	public static final Block block = null;
	public WeatheredCutCopperNStairsBlock(NegativeNModElements instance) {
		super(instance, 319);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(() -> new Block(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(1.0999999999999999f, 10f)
			...
			setRegistryName("weathered_cut_copper_n_stairs");
		}

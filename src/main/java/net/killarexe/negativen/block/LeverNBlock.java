...
public class LeverNBlock extends NegativenModElements.ModElement {
	@ObjectHolder("negativen:lever_n")
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(0.5f, 10f).setLightLevel(s -> 0).notSolid()

...
public class BlackstoneNWallBlock extends NegativeNModElements.ModElement {
	@ObjectHolder("negative_n:blackstone_n_wall")
	public static final Block block = null;
	public BlackstoneNWallBlock(NegativeNModElements instance) {
		super(instance, 176);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("blackstone_n_wall");
		}

...
public class ClassicIronOreBlock extends NegativenModElements.ModElement {
	@ObjectHolder("negativen:classic_iron_ore")
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("classic_iron_ore", "classic_iron_ore", blockAt -> {

...
public class PolishedBlackstoneNBlock extends NegativeNModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("polished_blackstone_n");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("negative_n:polished_blackstone_n_match"),
			...
			event.getRegistry().register(feature.setRegistryName("polished_blackstone_n"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("negative_n:polished_blackstone_n"), configuredFeature);
		}
	}
	@SubscribeEvent

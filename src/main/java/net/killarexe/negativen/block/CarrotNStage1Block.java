...
public class CarrotNStage1Block extends NegativeNModElements.ModElement {
	@ObjectHolder("negative_n:carrot_n_stage_1")
	public static final Block block = null;
	public CarrotNStage1Block(NegativeNModElements instance) {
		super(instance, 736);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("carrot_n_stage_1");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(0, 0, 0, 16, 6.4, 16)).withOffset(offset.x, offset.y, offset.z);
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CarrotsNItem.block, (int) (1)));
		}

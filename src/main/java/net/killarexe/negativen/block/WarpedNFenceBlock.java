...
public class WarpedNFenceBlock extends NegativeNModElements.ModElement {
	@ObjectHolder("negative_n:warped_n_fence")
	public static final Block block = null;
	public WarpedNFenceBlock(NegativeNModElements instance) {
		super(instance, 1059);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("warped_n_fence");
		}

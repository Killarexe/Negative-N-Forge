...
public class BrickNWallBlock extends NegativeNModElements.ModElement {
	@ObjectHolder("negative_n:brick_n_wall")
	public static final Block block = null;
	public BrickNWallBlock(NegativeNModElements instance) {
		super(instance, 968);
	}

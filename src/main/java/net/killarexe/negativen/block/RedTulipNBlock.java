...
public class RedTulipNBlock extends NegativeNModElements.ModElement {
	@ObjectHolder("negative_n:red_tulip_n")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("red_tulip_n"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("negative_n:red_tulip_n"), configuredFeature);
		}
	}
	@SubscribeEvent

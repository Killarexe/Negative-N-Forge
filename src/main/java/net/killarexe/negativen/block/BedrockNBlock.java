...
public class BedrockNBlock extends NegativenModElements.ModElement {
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		}.withConfiguration(new OreFeatureConfig(new BlockMatchRuleTest(Blocks.BEDROCK.getDefaultState().getBlock()) {
		...
		}, block.getDefaultState(), 22)).range(5).square().func_242731_b(22));
	}
}

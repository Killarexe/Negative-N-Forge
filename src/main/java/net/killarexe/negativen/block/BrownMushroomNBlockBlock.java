...
public class BrownMushroomNBlockBlock extends NegativeNModElements.ModElement {
	@ObjectHolder("negative_n:brown_mushroom_n_block")
	public static final Block block = null;
	public BrownMushroomNBlockBlock(NegativeNModElements instance) {
		super(instance, 1062);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("brown_mushroom_n_block");
		}

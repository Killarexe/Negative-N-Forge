...
public class SweetBerryNBushStage3Block extends NegativeNModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ORGANIC).sound(SoundType.PLANT).hardnessAndResistance(0f, 0f).setLightLevel(s -> 1)
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(SweetBerryNItem.block, (int) (3)));
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("negative_n:sweet_berry_n_bush_stage_3_match"),
			...
			feature = new OreFeature(OreFeatureConfig.CODEC) {
				...
				public boolean generate(ISeedReader world, ChunkGenerator generator, Random rand, BlockPos pos, OreFeatureConfig config) {
					...
					int y = pos.getY();
					int z = pos.getZ();
					if (!SweetBerryNBushStage3AdditionalGenerationConditionProcedure
			...
			event.getRegistry().register(feature.setRegistryName("sweet_berry_n_bush_stage_3"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("negative_n:sweet_berry_n_bush_stage_3"),
					configuredFeature);
		}
	}
	@SubscribeEvent

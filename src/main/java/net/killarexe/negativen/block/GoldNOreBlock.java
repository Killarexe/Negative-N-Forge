...
public class GoldNOreBlock extends NegativenModElements.ModElement {
	@ObjectHolder("negativen:gold_n_ore")
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("gold_n_ore", "gold_n_ore", blockAt -> {
			...
			}), block.getDefaultState(), 5)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(9, 0, 0, 24))));
		}
	}
}

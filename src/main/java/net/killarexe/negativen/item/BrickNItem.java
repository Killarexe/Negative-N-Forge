...
public class BrickNItem extends NegativeNModElements.ModElement {
	@ObjectHolder("negative_n:brick_n")
	public static final Item block = null;
	public BrickNItem(NegativeNModElements instance) {
		super(instance, 1052);
	}

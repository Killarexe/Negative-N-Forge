...
public class RawFilterRecipeItem extends NegativeNModElements.ModElement {
	@ObjectHolder("negative_n:raw_filter_recipe")
	public static final Item block = null;
	public RawFilterRecipeItem(NegativeNModElements instance) {
		super(instance, 1025);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof RawFilterRecipeGUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(NegativeNRessouresItemGroup.tab).maxStackSize(1).isImmuneToFire().rarity(Rarity.COMMON));
			setRegistryName("raw_filter_recipe");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Raw Filter Recipe");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new RawFilterRecipeGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {

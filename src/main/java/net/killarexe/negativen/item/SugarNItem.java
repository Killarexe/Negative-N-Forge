...
public class SugarNItem extends NegativeNModElements.ModElement {
	@ObjectHolder("negative_n:sugar_n")
	public static final Item block = null;
	public SugarNItem(NegativeNModElements instance) {
		super(instance, 1020);
	}

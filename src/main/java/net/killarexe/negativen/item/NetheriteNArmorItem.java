...
public class NetheriteNArmorItem extends NegativenModElements.ModElement {
	@ObjectHolder("negativen:netherite_n_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("negativen:netherite_n_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("negativen:netherite_n_armor_leggings")
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(NegativeNCombatItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "negativen:textures/models/armor/netherite_n__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}

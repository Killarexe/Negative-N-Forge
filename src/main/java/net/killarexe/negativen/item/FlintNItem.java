...
public class FlintNItem extends NegativeNModElements.ModElement {
	@ObjectHolder("negative_n:flint_n")
	public static final Item block = null;
	public FlintNItem(NegativeNModElements instance) {
		super(instance, 1054);
	}

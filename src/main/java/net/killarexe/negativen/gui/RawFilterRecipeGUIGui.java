...
import net.killarexe.negativen.procedures.PreviousPageButtonProcedure;
import net.killarexe.negativen.procedures.NextPageButtonProcedure;
...
public class RawFilterRecipeGUIGui extends NegativeNModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public RawFilterRecipeGUIGui(NegativeNModElements instance) {
		super(instance, 1025);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("raw_filter_recipe_gui"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, RawFilterRecipeGUIGuiWindow::new));
	}
		...
		if (buttonID == 1) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				PreviousPageButtonProcedure.executeProcedure($_dependencies);
			}
		}
	}

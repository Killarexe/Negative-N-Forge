...
@OnlyIn(Dist.CLIENT)
public class RawFilterGUIGuiWindow extends ContainerScreen<RawFilterGUIGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	public RawFilterGUIGuiWindow(RawFilterGUIGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("negative_n:textures/raw_filter_gui.png");
	@Override

...
@OnlyIn(Dist.CLIENT)
public class AnvilNGuiGuiWindow extends ContainerScreen<AnvilNGuiGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	public AnvilNGuiGuiWindow(AnvilNGuiGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {

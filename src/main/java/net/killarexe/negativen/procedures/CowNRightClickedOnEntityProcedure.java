...
public class CowNRightClickedOnEntityProcedure extends NegativeNModElements.ModElement {
	public CowNRightClickedOnEntityProcedure(NegativeNModElements instance) {
		super(instance, 999);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				NegativeNMod.LOGGER.warn("Failed to load dependency entity for procedure CowNRightClickedOnEntity!");
			return;
		}

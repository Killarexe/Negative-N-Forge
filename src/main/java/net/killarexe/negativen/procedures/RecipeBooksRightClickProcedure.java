...
public class RecipeBooksRightClickProcedure extends NegativeNModElements.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (world instanceof ServerWorld) {
			Entity entityToSpawn = new WitherNEntity.CustomEntity(WitherNEntity.entity, (World) world);
		...
		if (entity instanceof PlayerEntity) {
			ItemStack _stktoremove = new ItemStack(IngerRecipeGuideItem.block, (int) (1));

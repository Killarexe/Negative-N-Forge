...
public class ResistantEnchantment extends NegativeNModElements.ModElement {
	@ObjectHolder("negative_n:resistant")
	public static final Enchantment enchantment = null;
	public ResistantEnchantment(NegativeNModElements instance) {
		super(instance, 995);
	}

	@Override
	public void initElements() {
		elements.enchantments.add(() -> new CustomEnchantment(EquipmentSlotType.MAINHAND).setRegistryName("resistant"));
	}
